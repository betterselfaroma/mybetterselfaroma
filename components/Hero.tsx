...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-4 pb-20 pt-12 sm:px-6 lg:grid-cols-[48fr_52fr] lg:gap-16 lg:pb-28 lg:pt-20">
        {/* Left — copy */}
        <div>
        ...
        <div className="relative">
          ...
          <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[2.5rem] border border-cream-50/70 shadow-glow ring-1 ring-taupe-200/40 lg:aspect-auto lg:h-[36rem]">
